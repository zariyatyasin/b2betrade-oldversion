...
import Sizes from "./addToClick/Sizes";
...
export default function CreateProduct({ parents, categories }) {
  ...
  const createProduct = async () => {
    ...
    if (product.color.image) {
      ...
      const formData = new FormData();
      formData.append("file", temp, "image.png");
      ...
      >
        {(formik) => (
          <Form className=" flex gap-8">
            ...
            /> */}
            <div className=" bg-white p-4  flex-[2] border shadow rounded-lg ">
              <AdminInput
                type="text"
                label="Name"
                name="name"
            ...
            */}
            ...
            <div className="bg-white p-4  flex-1 border shadow rounded-lg">
              <CreateProductImage
                name="file"
